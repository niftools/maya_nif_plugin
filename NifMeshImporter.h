#ifndef _NIFMESHIMPORTER_H
#define _NIFMESHIMPORTER_H
...
class NifMeshImporter : NifTranslatorFixtureItem{
public:
	...
	NifMeshImporter(NifTranslatorOptions& translatorOptions, NifTranslatorData& translatorData, NifTranslatorUtils& translatorsUtils);
