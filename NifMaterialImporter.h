...
class NifMaterialImporter : NifTranslatorFixtureItem {
public:

	NifMaterialImporter();

	NifMaterialImporter(NifTranslatorOptions& translatorOptions, NifTranslatorData& translatorData, NifTranslatorUtils& translatorUtils);

	virtual ~NifMaterialImporter(); 
