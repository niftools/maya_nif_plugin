...
NifTranslatorUtils::NifTranslatorUtils() : translatorData(NifTranslatorData()), translatorOptions(NifTranslatorOptions()) {

}

NifTranslatorUtils::NifTranslatorUtils( NifTranslatorData& translatorData,NifTranslatorOptions& translatorOptions ) : translatorData(translatorData), translatorOptions(translatorOptions) {
